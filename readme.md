...
```
curl https://repo1.maven.org/maven2/de/mhus/conductor/conductor-launcher/1.1.0/conductor-launcher-1.1.0-install.sh | bash

or with wget:

wget -qO- https://repo1.maven.org/maven2/de/mhus/conductor/conductor-launcher/1.1.0/conductor-launcher-1.1.0-install.sh | bash
